...
class GmailEngine:
    def __init__(self, proxy_manager):
        ...
        self.debug_dir = "/root/gmail_creator/debug"
        ...
        while retry_count < max_retries and not blocking_detected:
            try:
                async with async_playwright() as p:
                    ...
                    browser = await p.chromium.launch(headless=config.HEADLESS, args=args)
                    ...
                    if proxy_server:
                        ...
                        print(f"🌐 Using proxy: {proxy_str[:40]}...")
                    ...
                    for step in range(50):
                        ...
                        if page_type == 'error':
                            ...
                            if result == "success":
                                ...
                                return {
                                    "success": False,
                                    "error": "Google blocking datacenter IP. Use RESIDENTIAL PROXIES!",
                                    "email_attempted": f"{custom_email}@gmail.com",
                                    "proxy_used": proxy_str,
                                    "blocked": True
                                }
                    ...
                    await page.screenshot(path=f"/root/gmail_creator/final_{custom_email}.png")
                    await browser.close()
